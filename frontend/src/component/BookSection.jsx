            ...
            >
              {[...books]
                ...
                .map((book) => (
                  <div
                    key={book._id}
                    className="bg-white shadow hover:shadow-lg transition duration-300 border-amber-50 flex flex-col h-full relative overflow-hidden group"
                  >
                    <div className="relative group overflow-hidden border border-gray-200 p-2 bg-white ">
                      ...
                      {book.oldPrice > book.discountPrice && (
                        <span className="absolute top-3 left-3 bg-purple-600 text-white text-xs font-bold px-2 py-1 rounded-full shadow">
                          -
                          {Math.round(
                            ((book.oldPrice - book.discountPrice) /
                              book.oldPrice) *
                    ...
                    <div className="p-4 text-center flex-grow flex flex-col relative z-10 bg-white">
                      <Link
                        to={`/${book.type}/${book.category}/${slugify(
                          book.name,
                          {
                      ...
                      <div className="mt-auto relative">
                        ...
                        <button
                          ...
                          className="mt-2 w-full bg-gradient-to-r from-purple-500 to-purple-500 text-white font-semibold py-2 hover:from-purple-600 hover:to-purple-600 transition-all duration-300 cursor-pointer relative z-10"
                        >
                          Buy Now
                        </button>
                        {book.type === "ebook" && (
