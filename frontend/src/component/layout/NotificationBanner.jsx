...
const NotificationBanner = () => {
  ...
  return (
    notification && (
      <div className="bg-purple-100 container border-b border-purple-200 text-purple-700 px-4 py-3 relative overflow-hidden">
        ...
        <div className=" mx-auto flex items-center justify-between">
          <div className="flex items-center">
            <FiBell className="mr-3 text-purple-500 animate-pulse" />
            {loading ? (
              "loading"
            ) : (
