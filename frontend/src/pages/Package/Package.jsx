                    ...
                    <div className="p-4 flex-grow flex flex-col">
                      ...
                      <div className="mt-auto pt-4 space-y-2">
                        <button
                          ...
                          className="w-full bg-gradient-to-r from-purple-500 to-purple-500 text-white font-medium py-2 rounded hover:from-purple-600 hover:to-purple-600 transition"
                        >
                          Buy Now
                        </button>
                        <button
