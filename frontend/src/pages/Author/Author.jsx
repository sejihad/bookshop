    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-purple-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3 mb-8 md:mb-0 flex justify-center">
                <div className="relative">
                  <div className="w-48 h-48 rounded-full bg-gradient-to-r from-purple-500 to-purple-700 shadow-2xl flex items-center justify-center">
                  ...
                  <div className="absolute -bottom-2 -right-2 bg-purple-600 text-white rounded-full py-1 px-3 text-xs font-bold shadow-lg">
                    105 Countries
                  </div>
                </div>
              </div>
          ...
          {/* Writing Section */}
          <div className="px-8 py-12 bg-gradient-to-r from-purple-600 to-purple-700 text-white">
          ...
          <div className="p-8 md:p-12">
            <div className="flex items-center mb-8 justify-center">
              <Globe className="text-purple-600 mr-3" size={28} />
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 mb-6 md:mb-0">
                <div className="bg-gradient-to-r from-cyan-500 to-purple-600 rounded-2xl p-6 text-white">
          ...
          <div className="px-8 py-12 text-center bg-gray-50">
            ...
            <Link
              className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 px-8 rounded-full inline-flex items-center transition duration-200"
              to="/shop"
            >
