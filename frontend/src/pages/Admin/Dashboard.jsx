  ...
  return (
    <div className="w-screen container max-w-full grid md:grid-cols-[1fr_5fr] min-h-screen bg-gray-100">
      ...
      <div className="bg-white p-8 overflow-x-hidden border-l border-gray-200">
        ...
        <div className="my-8">
          <div className="bg-gradient-to-r from-purple-600 to-cyan-400 text-white rounded-lg p-6 text-center mx-auto mb-8 w-4/5 shadow-md">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <Link
              to="/admin/orders"
              className="bg-gradient-to-r from-purple-500 to-purple-300 text-white w-44 h-44 rounded-lg flex flex-col justify-center items-center shadow hover:-translate-y-1 transition transform duration-300"
            >
            ...
            <Link
              to="/admin/users"
              className="bg-gradient-to-r from-purple-500 to-teal-300 text-white w-44 h-44 rounded-lg flex flex-col justify-center items-center shadow hover:-translate-y-1 transition transform duration-300"
            >
