        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="mb-6 flex justify-between items-center">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition-colors cursor-pointer"
            >
              {isFormOpen ? (
                <>
                  <FiX size={18} /> Close
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <option
                          ...
                          className={
                            countryObj.name === "All Countries"
                              ? "font-semibold text-purple-600 border-t border-gray-200 my-1"
                              : ""
                          }
                        >
                          {countryObj.name}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors hover:border-gray-400"
                  />
                </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                          <div className="flex gap-2">
                            <button
                              ...
                              className="p-2 text-purple-600 hover:bg-purple-50 cursor-pointer rounded-full transition-colors hover:shadow-sm"
                              title="Edit"
                            >
                              <FiEdit2 size={18} />
                            </button>
