...
const AdminOrderDetails = () => {
  ...
  const getStatusIcon = (status) => {
    switch (status?.toLowerCase()) {
      case "completed":
        return <FaCheckCircle className="text-purple-500 inline mr-2" />;
      case "cancelled":
  ...
  const getPaymentIcon = (method) => {
    switch (method?.toLowerCase()) {
      ...
      case "paypal":
        return <FaCreditCard className="text-purple-400 inline mr-2" />;
      default:
      ...
      <div className="flex-1 p-4 md:p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
            ...
            <Link
              to="/admin/orders"
              className="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 text-sm sm:text-base text-center"
            >
              ← Back to Orders
            </Link>
          </div>
              ...
              <form onSubmit={updateOrderHandler}>
                <div className="flex flex-col sm:flex-row gap-4">
                  <select
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-purple-500 focus:border-purple-500"
                    required
                  >
