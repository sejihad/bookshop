        ...
        <div className="flex-1 p-4 md:p-8 overflow-x-hidden">
          ...
          <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Link
                to="/admin/book/new"
                className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg transition-colors cursor-pointer text-sm sm:text-base shadow-sm hover:shadow-md"
              >
            ...
            {loading ? (
              ...
              <div className="text-center py-12">
                <div className="max-w-md mx-auto">
                  ...
                  <Link
                    to="/admin/book/new"
                    className="inline-flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg transition-colors cursor-pointer"
                  >
