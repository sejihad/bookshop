      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1 p-4 md:p-8">
          <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
            <div className="bg-gradient-to-r from-purple-500 to-purple-500 p-4 md:p-6">
            ...
            >
              ...
              <div className="space-y-1 md:space-y-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 md:px-4 md:py-3 text-sm md:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-300"
                />
              </div>
