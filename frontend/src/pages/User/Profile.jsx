...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-50 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            {/* Profile Banner */}
            <div className="h-32 bg-gradient-to-r from-purple-500 to-purple-600 relative">
