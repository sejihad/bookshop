        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-purple-50 flex items-center justify-center p-4">
          <div className="w-full max-w-md">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 text-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent to-white opacity-10"></div>
                <h2 className="text-2xl font-bold text-white relative z-10">
                  Update Your Password
                </h2>
                <p className="text-purple-100 mt-1 relative z-10">
              ...
              <form className="p-6 space-y-5" onSubmit={updatePasswordSubmit}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 pl-10 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition"
                ...
                <button
                  type="submit"
                  className="w-full py-3 px-4 bg-gradient-to-r from-purple-600 cursor-pointer to-purple-600 hover:from-purple-700 hover:to-purple-700 text-white font-medium rounded-lg shadow-md transition-all duration-300 mt-4"
                >
                  Update Password
                </button>
              </form>
