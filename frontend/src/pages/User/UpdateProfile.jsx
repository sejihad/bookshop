                ...
                <form className="p-6 space-y-5" onSubmit={updateProfileSubmit}>
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      <div className="relative group">
                        ...
                        />
                        {/* Pencil Icon */}
                        <div className="absolute bottom-0 right-0 bg-purple-600 p-2 rounded-full shadow-md transition-all duration-300 group-hover:bg-purple-700">
                          <svg
                  ...
                  <div className="space-y-1" ref={countryDropdownRef}>
                    ...
                    <div className="relative">
                      <div
                        className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition flex items-center justify-between cursor-pointer"
                        onClick={() =>
                  ...
                  <div className="space-y-1">
                    ...
                    <PhoneInput
                      ...
                      className="w-full "
                      inputClassName="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 outline-none transition"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-3 px-4 bg-gradient-to-r from-purple-600 to-purple-600 cursor-pointer hover:from-purple-700 hover:to-purple-700 text-white font-medium rounded-lg shadow-md transition-all duration-300 ${
