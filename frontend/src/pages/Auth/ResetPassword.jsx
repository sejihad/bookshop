      ...
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-[#e2e2e2] to-[#c9d6ff] px-4">
        <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-[0_0_30px_rgba(0,0,0,0.2)] p-10 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-purple-600 hover:bg-purple-500 text-white cursor-pointer py-3 rounded-xl font-semibold shadow-md transition"
            >
              Reset Password
            </button>
          </form>
          ...
          <p className="text-sm text-center mt-6 text-gray-600">
            ...
            <Link
              to="/login"
              className="text-purple-500 font-medium hover:underline ml-1"
            >
              Login
            </Link>
          </p>
